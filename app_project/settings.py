...
# ─── SECURITY ────────────────────────────────────────────────────────────────
SECRET_KEY = config('SECRET_KEY', default='apc-super-secret-key-change-in-production-immediately')
...
THIRD_PARTY_APPS = [
    ...
    'parler',               # internationalization
    # NEW THIRD PARTY APPS
    'django_elasticsearch_dsl',  # for search
    'guardian',                   # for object permissions
    'cryptography',               # for encrypting fields
]
...
MIDDLEWARE = [
    ...
    # NEW MIDDLEWARE
    'core.middleware.multi_tenant.MultiTenantMiddleware',   # sets current organization
]
...
APC_SETTINGS = {
    ...
    'MAX_POST_MEDIA_SIZE': 100 * 1024 * 1024,  # 100MB
    'MAX_MESSAGE_ATTACHMENT_SIZE': 50 * 1024 * 1024,  # 50MB
